...
<Grid item id='upperHeader' xs={12} sx={{ width:'100%', overflowX:'hidden' ,display:'flex', justifyContent:'left', padding:'20px 0px 10px 30px', backgroundColor:'rgb(237, 240, 249)' }} >
    <Typography sx={{fontSize:'15px', marginRight:'15px', color:'#0d47a1', fontWeight:'700', whiteSpace:'nowrap'}}>RECHARGE</Typography>
     <Typography sx={{fontSize:'15px' , marginRight:'15px', color:'#0d47a1', fontWeight:'700',whiteSpace:'nowrap'}}>DEDUCTION HISTORY</Typography>
      <Typography sx={{fontSize:'15px', color:'#0d47a1', fontWeight:'700',whiteSpace:'nowrap'}}>TRANSACTION HISTORY</Typography>
