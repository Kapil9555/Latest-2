...
const Search = () => {
    ...
    const tableHead=['TRACKING DETAILS','ORDER DETAILS','STATUS', 'DIMENSIONAL WEIGHT(CM/KG)','ORDER AMOUNT (₹)','ADDRESS DETAILS','ACTIONS']
  ...
  return (
    <>
      ...
      <Grid xs={12} md={6} lg={5} sx={{p:"20px"}}  >
         ...
         <Grid item xs={12} md={6} lg={3} sx={{p:"20px"}}>
