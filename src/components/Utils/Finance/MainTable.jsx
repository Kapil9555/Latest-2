                                ...
                                <Table>
                                    <TableHead>
                                        <TableRow>
                                           ...
                                           <TableCell sx={{borderRight:"1px solid #f0f0f0",borderBottom:"1px solid #f0f0f0"}}>
                                            <Typography sx={{fontWeight:"800",color:"rgb(38, 63, 151)"}}>Min COD Charge</Typography>
                                           </TableCell>

                                           <TableCell sx={{borderRight:"1px solid #f0f0f0",borderBottom:"1px solid #f0f0f0"}}>
                                            <Typography sx={{fontWeight:"800",color:"rgb(38, 63, 151)"}}>COD Percentage</Typography>
                                           </TableCell>
                                        ...
                                        </TableRow>
                                        {
                                          expressTable.map((ele)=>{
                                            return( <TableRow >
                                                    ...
                                                    <TableCell sx={{fontWeight:"800",color:"rgb(38, 63, 151)",borderRight:"1px solid #f0f0f0"}}>{ele.c8}</TableCell>

                                                    <TableCell sx={{fontWeight:"800",color:"rgb(38, 63, 151)",borderRight:"1px solid #f0f0f0"}}>{ele.c9}</TableCell>
